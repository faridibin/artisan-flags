...
class CreateFeatureTest extends TestCase
{
    ...
    /** @test */
    public function the_new_feature_command_creates_a_new_feature()
    {
        $this->artisan('laraflags:new-feature', ['feature' => 'test-feature'])
    ...
    /** @test */
    public function the_new_feature_command_prompts_for_a_name_if_not_provided()
    {
        $this->artisan('laraflags:new-feature')
    ...
    /** @test */
    public function the_new_feature_command_prompts_for_a_name_if_feature_exists()
    {
    ...
    /** @test */
    public function the_new_feature_command_creates_a_new_feature_and_attaches_to_group_when_provided()
    {
    ...
    /** @test */
    public function the_new_feature_command_creates_a_new_feature_and_attaches_to_new_group_when_provided()
    {
        $this->artisan('laraflags:new-feature', [
            'feature' => 'test-feature',
            '--group' => 'test-feature-group'
