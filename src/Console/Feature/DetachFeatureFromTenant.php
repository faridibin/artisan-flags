...
class DetachFeatureFromTenant extends Command
{
    // use FeatureFlags;
     ...
     * @var string
     */
    protected $signature = 'laraflags:detach-to-tenant {feature?} {--t|tenant=*}';
     ...
     * @var string
     */
    protected $description = 'Detaches a feature flag to a tenant';
    ...
    public function handle()
    {
        ...
        //         $this->comment("The feature [{$feature->name}] is already detached to tenant [{$tenant->$identifier}]!");

        //         continue;
        //     }

        //     $feature->tenants()->detach($tenant);

        //     $this->comment("The feature [{$feature->name}] was detached to tenant [{$tenant->$identifier}]!");
        // }
